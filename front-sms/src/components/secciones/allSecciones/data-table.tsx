...
interface DataTableProps<TData, TValue> {
  ...
  data: TData[];
  filtroGrado?: string;
  filtroCicloLectivo?: string;
}

export function DataTable<TData extends Seccion, TValue>({
  columns,
  data,
  filtroGrado = "",
  filtroCicloLectivo = "",
  ...
  const filteredData = React.useMemo(() => {
    ...
    return filtered;
  }, [data, filtroGrado, filtroCicloLectivo]);
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link href="/dashboard/secciones/nuevo" passHref>
            <Button variant="default">Nueva Seccion</Button>
          </Link>
        </div>
      </div>
